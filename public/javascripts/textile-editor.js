	...
	prepareButton: function(button) {
	    ...
	    theButton.setAttribute('tagStart', button.tagStart);
   	  ...
   	  theButton.setAttribute('open', button.open);
		  ...
		  img.src = SITE_ROOT+'images/textile-editor/' + button.display;
...
document.write('<script src="'+SITE_ROOT+'javascripts/textile-editor-config.js" type="text/javascript"></script>');